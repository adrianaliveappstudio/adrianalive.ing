...
window.addEventListener("message", (event) => {
    ...
    if (event.data.type && (event.data.type === "xtPage-547BB7B6-7345-41C8-8CCB-A09999B89924")) {
        ...
        if (!isCustomizedBugCreated) {
            ...
            chrome.runtime.sendMessage({ notificationType: "0", data: { id: event.data.id, type: event.data.workItemtype, title: event.data.title } }, (response) => {
            });
        }
    }
    ...
    if (event.data.type && (event.data.type === "xtPage-traceability-c07e08f5-c27c-4025-868c-e4ddc3947767")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "3" }, (response) => {
            if (!response) {
    ...
    if (event.data.type && (event.data.type === "xtPage-traceability-workItem")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "2", data: { workItem: workItemObject, tfsTeamPath: tfsTeamPath } }, (response) => {
        });
    }
    if (event.data.type && (event.data.type === "xtPage-get-activeTabs-metaData-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "51", data: {} }, (response) => {
    ...
    if (event.data.type && (event.data.type === "xtPage-capture-screenshot-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "52", data: event.data.screenshotPayload }, (response) => {
        });
    }
    if (event.data.type && (event.data.type === "xtPage-capture-desktopScreenshot-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "83", data: event.data.screenshotPayload }, (response) => {
    ...
    if (event.data.type && (event.data.type === "xtPage-get-systemInfo-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "57", data: {} }, (response) => {
    ...
    if (event.data.type && (event.data.type === "xtPage-start-video-capture-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "58", data: event.data.videoCapturePayload }, (response) => {
    ...
    if (event.data.type && (event.data.type === "xtPage-stop-video-capture-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "59", data: {} }, (response) => {
        });
    }
    if (event.data.type && (event.data.type === "xtPage-start-capture-action-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "66", data: event.data.startActionLogPayload }, (response) => {
        });
    }
    if (event.data.type && (event.data.type === "xtPage-stop-capture-action-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "67", data: event.data.actionLogPayload }, (response) => {
        });
    }
    if (event.data.type && (event.data.type === "xtPage-generate-inprogress-action-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "68", data: event.data.actionLogPayload }, (response) => {
        });
    }
    if (event.data.type && (event.data.type === "xtPage-get-isSessionActive-v1")) {
        //Notification type 75 is for VerifyIfSessionIsRunning
        chrome.runtime.sendMessage({ notificationType: "75", data: {} }, (response) => {
    ...
    if (event.data.type && (event.data.type === "xtPage-configure-xt-v1")) {
        ...
        chrome.runtime.sendMessage({ notificationType: "76", data: event.data.configSettings }, (response) => {
